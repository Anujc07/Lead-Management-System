          ...
          rows.forEach(function(row) {
              ...
              if (cells.length >= 8) {
                  ...
                  if (bookingSpan) {
                      ...
                      targetBookings += parseInt(bookingValue) || 0;
                  }
                  ...
                  if (homeVisitSpan) {
                      ...
                      targetHomeVisits += parseInt(homeVisitValue) || 0;
                  }
                  ...
                  if (corpVisitSpan) {
                      ...
                      targetCorpVisits += parseInt(corpVisitValue) || 0;
                  }
                  ...
                  if (customerFWSpan) {
                      ...
                      targetCustomerFW += parseInt(customerFWValue) || 0;
                  }
                  ...
                  if (smFWSpan) {
                      ...
                      targetSmFW += parseInt(smFWValue) || 0;
                  }
              }
          });
